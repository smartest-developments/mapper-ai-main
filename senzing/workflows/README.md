...
```bash
python3 /Users/simones/Developer/mapper-ai-main/senzing/workflows/mapper/run_mapper_jsonl.py \
...
```bash
python3 /Users/simones/Developer/mapper-ai-main/senzing/workflows/testing/run_management_tests.py \
